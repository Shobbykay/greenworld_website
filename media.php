...
<head>
    ...
    <meta content="Media | Greenworld Touching Lives Initiative" name="description">
    <meta content="Greenworld Touching Lives Initiative, Media, Ibadan, Oyo" name="keywords">
    <meta content="Kayode Shobalaje" name="author">
    <title>Media | Touching Lives Initiative</title>
    ...
    <meta name="twitter:description" content="Media | Welcome to Greenworld Touching Lives Initiatives">
    ...
    <div class="heder">
        ...
        <div class="mlpjd">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="big_text_slider txt-curve text-center">Media</h1>
                        <h3 class="text-muted skal mt-4 text-center">Browse through our image list of events</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="grekko">
        <div class="container">
            <div class="text-center">
                <h4 class="ic_kflls heading_hos">There are no media to show right now</h4>
            </div>
                ...
                <div class="col-md-9">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 mb-4">
                            ...
                            <ul class="menut foot-menu">
                                <li><a href="grant" class="">Our Grant</a></li>
                                <li><a href="career">Career</a></li>
                            </ul>
                        </div>
                        <div class="col-md-8">
