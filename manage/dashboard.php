...
//get data
$q="SELECT * FROM grant_application";
    ...
    <div class="in_body">
        ...
        <div class="row m-t-50">
            <div class="col-md-3">
                ...
                <ul class="sidebar">
                    <li><a href="#" class="active"><i data-feather="aperture"></i> Grant Apps.</a></li>
                    <li><a href="employment"><i data-feather="briefcase"></i> Employment Apps.</a></li>
                ...
                <div class="cardbox">
                    <div class="flex-container">
                        ...
                        <div class="flex-child ghgkdosos">
                            <h2 class="djkaia">Grant Applications</h2>
                            <small class="text-muted">List of applications received from the website</small>
                                ...
                                <?php
                                    ...
                                    if ($n>0){
                                        ...
                                        while($f=mysqli_fetch_assoc($q__)){
                                            ...
                                            <tr>
                                                <th><?= $i ?></th>
                                                <td><a href="#" class="linka"><?= $f['fullname'] ?></a></td>
